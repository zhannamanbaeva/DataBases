...
SELECT employees.department, COUNT(*) FROM employees GROUP BY employees.department;
...
SELECT name FROM employees WHERE employees.city = 'Almaty'
UNION SELECT name FROM customers WHERE customers.city = 'Almaty';

SELECT * FROM departments WHERE departments.budget > 60000 ORDER BY budget ASC, code DESC;
